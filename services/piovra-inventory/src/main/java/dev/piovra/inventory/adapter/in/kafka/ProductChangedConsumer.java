...
import dev.piovra.inventory.application.service.StockLevelInitializer;
...
@Component("inventoryProductChangedConsumer")
public class ProductChangedConsumer {

    private final StockLevelInitializer initializer;

    public ProductChangedConsumer(StockLevelInitializer initializer) {
