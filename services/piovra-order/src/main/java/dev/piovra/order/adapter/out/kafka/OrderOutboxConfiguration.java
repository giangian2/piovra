...
public class OrderOutboxConfiguration extends AbstractOutboxConfiguration<OrderOutboxEvent> {

    public OrderOutboxConfiguration(
    ...
    @Bean
    public OutboxWriter orderOutboxWriter() {
        return writer;
    }

    @Bean
    public OutboxRelay<OrderOutboxEvent> orderOutboxRelay() {
        return relay;
    }
}
